...
All files in `knowledge/`, organized by category. Check here before starting a new file or learning session.
...
|------|-------------|--------|
| [stoicism.md](philosophy/stoicism.md) | Stoic philosophy — core ideas, practices, key figures | Active reference |
| [zen-buddhism.md](philosophy/zen-buddhism.md) | Zen Buddhism — core ideas, practices, key figures | Active reference |
| [philosophy-traditions-guide.md](philosophy/philosophy-traditions-guide.md) | How 10+ traditions map to the 7 core tenets — cross-tradition comparison | Reference |
| [core_tenets_of_wisdom.md](philosophy/core_tenets_of_wisdom.md) | The 7 ideas every major philosophy agrees on — with commentary | Active reference |
| [stoic-daily-practice.md](philosophy/stoic-daily-practice.md) | Morning review, evening reflection, negative visualization, memento mori — the actual practice | Reference |
| [decision-making.md](philosophy/decision-making.md) | Stoic framework for hard decisions: dichotomy of control, virtue test, premeditatio malorum, amor fati | Reference |

## Roma

| File | Description | Status |
|------|-------------|--------|
| [roma.md](roma/roma.md) | The Book of Roma — personal tenets drawn from study and life | Active — ongoing |
| [sacred-text-plan.md](roma/sacred-text-plan.md) | Study plan for sacred texts feeding into Roma | Active |
| [roma-improvements.md](roma/roma-improvements.md) | Improvement outline and status tracker for Roma | Active |
...
| [mobility-and-flexibility.md](health/mobility-and-flexibility.md) | Active range of motion — the four priority joints, daily 10-min practice, connection to kettlebell training | Reference |
...
| File | Description | Status |
|------|-------------|--------|
| [science-literacy.md](science/science-literacy.md) | How to read a study, p-values, effect sizes, replication crisis, spotting bad science | Reference |
...
| File | Description | Status |
|------|-------------|--------|
| [using-this-system.md](meta/using-this-system.md) | How romi-01 works and how to use it | Reference |
| [vscode-claude-workflow.md](meta/vscode-claude-workflow.md) | VS Code + Claude extension workflow guide | Reference |
| [how-claude-works.md](meta/how-claude-works.md) | Transformer architecture, context windows, hallucination, what Claude is good and bad at | Reference |
| [wiki-plan.md](wiki-plan.md) | Full roadmap of planned knowledge files — what to build next | Active |

---

## Adding New Files

Use `@prompts/deep-dive.md [topic]` to generate a new wiki-style knowledge file. The prompt handles placement, depth, and proposes sub-topic files for future exploration.

New domains get new subfolders (e.g., `knowledge/farming/`, `knowledge/skills/`).

## Status Key
- **Active reference** — used regularly, kept up to date
- **Active — ongoing** — being written or extended
- **Reference** — stable, not frequently updated
- **Draft** — initial notes, not complete
